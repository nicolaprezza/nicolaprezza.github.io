...
My research activity is focused on the study of algorithms for the manipulation and analysis of compressed data, both from the theoretical and practical viewpoints. My main contributions include (i) the introduction of the notion of *string attractor* (STOC '18), a new combinatorial object able to unify the main compressors for repetitive sequences studied from the 70's (for example, Lempel-Ziv 77), and (ii) the *r-index* (SODA '18), a data structure that solves a problem (optimal-time locate on FM-indexes) that has been open for almost two decades. The Italian Chapter of the European Association for Theoretical Computer Science (IC-EATCS) awarded me the *best italian young researcher in Theoretical Computer Science 2018* award for my contributions to theoretical computer science, and my PhD thesis won one of the two *best scientific PhD theses in 2017* award at the university of Udine. I am also author of the first C++ library of compressed dynamic data structures (https://github.com/xxsds/DYNAMIC) and several other software tools for bioinformatics and data compression. 
